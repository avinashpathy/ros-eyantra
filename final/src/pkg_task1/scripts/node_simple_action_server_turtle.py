...
from pkg_ros_actions.msg import msgTurtleResult       # Message Class that is used for Result messages
from pkg_ros_actions.msg import msgTurtleFeedback     # Message Class that is used for Feedback messages
