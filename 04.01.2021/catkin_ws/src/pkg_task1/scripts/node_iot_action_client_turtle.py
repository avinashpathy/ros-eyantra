...
class SimpleActionClientTurtle:
    ...
    def __init__(self):
        self._ac = actionlib.SimpleActionClient('/action_turtle',
                                                msgTurtleAction)
        self._as = actionlib.SimpleActionClient('/action_ros_iot',
                                                  msgRosIotAction)
...
def start(my_msg):
    if(my_msg.message == "start"):                       #if input message from mqtt is start, then the client starts sending goal
