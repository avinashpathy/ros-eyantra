...
class msgIotRosActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = msgIotRosGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += msgIotRosGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new msgIotRosActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = msgIotRosGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new msgIotRosGoal()
    }
...
module.exports = msgIotRosActionGoal;
