...
"""autogenerated by genpy from pkg_task1/msgTurtleActionResult.msg. Do not edit."""
import sys
...
class msgTurtleActionResult(genpy.Message):
  ...
  _type = "pkg_task1/msgTurtleActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pkg_task1/msgTurtleResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = pkg_task1.msg.msgTurtleResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pkg_task1.msg.msgTurtleResult()
