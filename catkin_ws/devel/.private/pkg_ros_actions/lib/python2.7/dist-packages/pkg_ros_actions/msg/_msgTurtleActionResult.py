...
"""autogenerated by genpy from pkg_ros_actions/msgTurtleActionResult.msg. Do not edit."""
import sys
...
class msgTurtleActionResult(genpy.Message):
  _md5sum = "9947ff0cda32e84a022d3d6978fa6c68"
  _type = "pkg_ros_actions/msgTurtleActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pkg_ros_actions/msgTurtleResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(msgTurtleActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = pkg_ros_actions.msg.msgTurtleResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pkg_ros_actions.msg.msgTurtleResult()
