...
class CartesianPath:
	...
	print("this is the number of the argument passed {}".format(number))
        if(number==1):
            self.act_vac()
	   # self.ee_cartesian_translation(0.122,0.36,0.13)
	    ...
	    #rospy.sleep(1)
	    print("taking to the position of above the box have to see whether it works")
	    y = 0.65
            x = 0.11
            z = 1.2
	    ...
	    #rospy.sleep(1)
            self.act_vac()
	  #  self.ee_cartesian_translation(0.615,0.213,0.66)
	    ur5_4_home_pose.position.x = 0.81
            ur5_4_home_pose.position.y = 0.0
            ur5_4_home_pose.position.z = 0.944
            ur5_4_home_pose.orientation.x = -0.5
            ur5_4_home_pose.orientation.y = -0.5
            ur5_4_home_pose.orientation.z = 0.5
            ur5_4_home_pose.orientation.w = 0.5
        ...
        if(number==3):
   	    ...
   	    #ur5_2_home_pose.position.x = pos_x
	    ur5_2_home_pose.orientation.x = -0.5
   	    ...
   	    ur5_2_home_pose.orientation.z = 0.5
            ...
            #ur5_2_home_pose.position.y = pos_y
    	    ur5_2_home_pose.position.z = 1 
           # self.go_to_pose(ur5_2_home_pose)
            self.ee_cartesian_translation(-0.2,0,0)
            self.act_vac()
            #self.ee_cartesian_translation(0.245,-0.31,0.05)
	    #self.ee_cartesian_translation(0.723,-0.39,0)
            self.go_to_pose(ur5_4_home_pose)
            self.dact_vac()
            #self.constart()
    def act_vac(self):
...
def main():
   ...
   # constart()
    ...
    ur5_2_home_pose.orientation.z = 0.5
    ur5_2_home_pose.orientation.w = 0.5
   # ur5_5_home_pose = geometry_msgs.msg.Pose()#this is the line of error, attribute error
