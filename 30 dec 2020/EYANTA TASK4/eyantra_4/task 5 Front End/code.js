...
xmlhttp.onreadystatechange = function () {
  if (this.readyState == 4 && this.status == 200) {
    ...
    for (i = 0; i < data1.length; i++) {
      ...
      tt[i] = TimeTaken;
      let xcor = data1[i]["gsx$xcoordinate"]["$t"];
      xc[i] = xcor;
      let ycor = data1[i]["gsx$ycoordinate"]["$t"];
      yc[i] = ycor;
...
xmlhttp.open(
  "GET",
  "https://spreadsheets.google.com/feeds/list/15A6EkI4YmESoc_ydhap2GIbYZ57jz0rgBw3y54DSQTA/od6/public/values?alt=json",
  true
);
xmlhttp.send();
